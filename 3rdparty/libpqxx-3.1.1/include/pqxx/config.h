...
#define PACKAGE_STRING "libpqxx 3.1.1"
...
/* Define if libpq has PQescapeBytea() */
#define PQXX_HAVE_PQESCAPEBYTEA 1

/* Define if libpq has PQescapeByteaConn() */
...
/* Define if libpq has PQexecParams() */
#define PQXX_HAVE_PQEXECPARAMS 1

/* Define if libpq has PQexecPrepared() */
#define PQXX_HAVE_PQEXECPREPARED 1

/* Define if libpq has PQfreemem() */
#define PQXX_HAVE_PQFREEMEM 1

/* Define if libpq has PQfreeNotify() */
#define PQXX_HAVE_PQFREENOTIFY 1

/* Define if libpq has PQftable() */
#define PQXX_HAVE_PQFTABLE 1

/* Define if libpq has PQftablecol() */
